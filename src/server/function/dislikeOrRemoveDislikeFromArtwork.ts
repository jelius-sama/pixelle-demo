...
export default async function dislikeOrRemoveDislikeFromArtwork({ artId }: { artId: bigint; }): Promise<{ status: ExpectedStatus | (number & {}), message: ExpectedMessages | (string & {}); operation: OperationPerformed; }> {
